...
from app.api import routes, system_routes
from app.api import websocket as ws_handler
from app.config import get_settings
from app.core.audit_logger import EventType, get_audit_logger
from app.core.brain import AIBrain
from app.core.connection_pool import close_connection_pool, get_connection_pool
...
async def lifespan(app: FastAPI):
    ...
    logger.info("=" * 60)
    logger.info("AIZEN Backend server started successfully!")
...
@app.get("/")
async def root():
    return {"status": "healthy", "service": "AI Assistant Backend", "version": "1.0.0"}
...
async def get_metrics_endpoint():
    ...
    return PlainTextResponse(content=metrics.to_prometheus_format(), media_type="text/plain")
...
async def get_metrics_json():
    ...
    return {"metrics": metrics.get_all_metrics(), "cache": cache_stats}
