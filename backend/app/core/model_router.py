...
class ModelRouter:
        ...
        self.routing_table = {
            TaskType.CODING: {
                ...
                "fallback": [
                    ...
                    (ModelProvider.OLLAMA, self.settings.ollama_model),
                ],
            },
            ...
            TaskType.GENERAL_CHAT: {
                ...
                "fallback": [
                    (ModelProvider.GROQ, "groq/compound"),
                    (ModelProvider.OLLAMA, self.settings.ollama_model),
                ],
            },
            TaskType.WEB_SEARCH: {
                ...
                "fallback": [
                    (ModelProvider.GEMINI, self.settings.model_chat),
                    (ModelProvider.OLLAMA, self.settings.ollama_model),
                ],
            },
            TaskType.DEEP_RESEARCH: {
                ...
                "fallback": [
                    (ModelProvider.PERPLEXITY, self.settings.model_search),
                    (ModelProvider.GEMINI, self.settings.model_reasoning),
                ],
            },
    ...
    def select_model(
        self,
        task_type: TaskType,
        manual_provider: ModelProvider | None = None,
        ...
        for fallback_provider, fallback_model in route.get("fallback", []):
            if self._is_provider_available(fallback_provider):
                logger.info(
                    f"Using fallback {fallback_provider}/{fallback_model} for task type {task_type}"
                )
        ...
        available = {
            "gemini": {
                ...
                "models": [
                    {
                        "name": "gemini-3-flash",
                        "description": "2026 standard for high-volume chat and coding",
                    },
                    {
                        "name": "gemini-3.1-pro",
                        "description": "The peak of reasoning and agentic workflows",
                    },
                    {
                        "name": "gemini-3-pro-preview",
                        "description": "Advanced reasoning (legacy preview)",
                    },
                ],
            },
            "groq": {
