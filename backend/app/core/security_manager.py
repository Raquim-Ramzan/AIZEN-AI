...
class SecurityManager:
    ...
    def classify_operation(self, operation_type: str, parameters: Dict[str, Any]) -> OperationRiskLevel:
        """
        ...
        base_risk = self.RISK_CLASSIFICATIONS.get(
            operation_type, 
            OperationRiskLevel.NEEDS_APPROVAL
        )
