...
class MemoryManager:
    ...
    def __init__(self, vector_store: VectorStore, core_memory: CoreMemory, conversation_manager: ConversationManager):
    ...
    async def get_context_for_conversation(self, conversation_id: str, query: str) -> Dict[str, Any]:
