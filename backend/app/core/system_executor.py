...
class SystemOperationExecutor:
    ...
    async def _open_url(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
    ...
    async def _search_web(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
        ...
        try:
            ...
            messages = [
                {
                    "role": "system",
                    "content": "You are a web search assistant. Provide search results for the given query.",
                },
                {"role": "user", "content": query},
            ]

            # Use Perplexity via AIBrain
            response = await brain.generate(messages=messages, provider=ModelProvider.PERPLEXITY)

            content = (
                response.get("choices", [{}])[0]
                .get("message", {})
                .get("content", "No results found.")
            )
    ...
    async def _start_process(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
        """Start a process"""
        ...
        try:
            ...
            op.result = result
            self.security_manager.log_operation(op)
            return {"success": True, "operation_id": op.id, "status": "completed", "result": result}
        except Exception as e:
            op.status = OperationStatus.FAILED
            op.error = str(e)
            self.security_manager.log_operation(op)
    ...
    async def _list_processes(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
    ...
    async def _kill_process(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
    ...
    async def _read_file(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
    ...
    async def _write_file(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
    ...
    async def _search_files(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
        ...
        try:
            result = await self.file_ops.search_files(
                start_path=start_path, pattern=pattern, max_results=max_results
            )
            return {"success": True, "status": "completed", "result": result}
        except Exception as e:
            return {"success": False, "error": str(e)}

    async def _delete_file(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
    ...
    async def _get_cpu_info(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
    ...
    async def _get_memory_info(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
    ...
    async def _get_disk_info(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
    ...
    async def _type_text(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
    ...
    async def _press_key(self, params: dict[str, Any], user_id: str | None) -> dict[str, Any]:
