...
class FileOpsTool(BaseTool):
    ...
    async def _read_file(self, path: str) -> dict[str, Any]:
        ...
        if not client:
            return {"error": "Storage client unavailable"}
        ...
        try:
            ...
            return {"operation": "read", "path": path, "content": content, "size": len(content)}
        except Exception as e:
    ...
    async def _write_file(self, path: str, content: str) -> dict[str, Any]:
        ...
        try:
            client.storage.from_(self.bucket_name).upload(
                path, content.encode("utf-8"), {"upsert": "true"}
            )

            return {"operation": "write", "path": path, "size": len(content), "success": True}
        except Exception as e:
    ...
    async def _list_directory(self, path: str) -> dict[str, Any]:
        ...
        try:
            ...
            return {"operation": "list", "path": path, "items": items, "count": len(items)}
        except Exception as e:
