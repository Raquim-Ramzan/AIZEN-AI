...
class CalendarTool(BaseTool):
    ...
    def __init__(self):
        ...
        self.parameters = {
            ...
            "properties": {
                ...
                "title": {"type": "string", "description": "Reminder or task title"},
                "time": {"type": "string", "description": "Time for reminder (ISO format)"},
    ...
    async def _create_reminder(self, title: str, time: str) -> dict[str, Any]:
        ...
        try:
            reminder_time = (
                datetime.fromisoformat(time) if time else datetime.now(UTC) + timedelta(hours=1)
            )
            ...
            return {"operation": "create_reminder", "reminder": reminder, "success": True}
        except Exception as e:
            return {"error": str(e)}
    ...
    async def _create_task(self, title: str, description: str = "") -> dict[str, Any]:
        ...
        return {"operation": "create_task", "task": task, "success": True}

    async def _list_tasks(self) -> dict[str, Any]:
        """List all tasks"""
        return {"operation": "list_tasks", "tasks": self.tasks, "count": len(self.tasks)}
