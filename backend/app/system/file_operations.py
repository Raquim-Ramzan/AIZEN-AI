...
class FileOperations(SystemController):
    ...
    async def delete_file(
        ...
        async def executor(params: dict[str, Any]) -> dict[str, Any]:
            ...
            return {"path": str(file_path), "deleted": True, "recycled": params["use_recycle_bin"]}
    ...
    async def list_directory(
        ...
        return await self.execute_operation(
            ...
            parameters={"path": path, "recursive": recursive, "pattern": pattern},
            executor=executor,
            approval_callback=approval_callback,
        )
    ...
    async def search_files(
        ...
        return await self.execute_operation(
            ...
            parameters={"start_path": start_path, "pattern": pattern, "max_results": max_results},
            executor=executor,
            approval_callback=approval_callback,
        )
