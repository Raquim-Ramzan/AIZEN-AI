...
async def test_rag_system():
    ...
    from app.memory.rag_manager import RAGManager, initialize_rag_manager
    ...
    print(f"  [OK] Context retrieved: {context['metadata']['memory_hits']} memories, "
    ...
    print(f"  [OK] Exchange processed: {result['facts_extracted']} facts extracted, "
